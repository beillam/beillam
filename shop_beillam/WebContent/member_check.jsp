...
.n_logo {
	...
	box-sizing: border-box;
	background: url("img/logo2.png") 50% 100% no-repeat;
}
.lang {
	position: absolute;
	right: 0px;
...
<body>
			...
			<form id="join_content">
				...
				<img alt="로고" src="img/beil.png" width="110px" height="30px">
					...
					<ul id="terms_ul">
						...
						<li id="terms_ul_li1"><span class="ul_li_span"> <input

								type="checkbox" id="li1box" class="ckboxs"> <label

								for="li1box" class="label1"> 이용약관 동의<span
							...
							<div class="terms_box">
								...
								<div class="article">
									...
									서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한<br>

										서비스의 이용과 관련하여 서비스를 제공하는 베일람 주식회사(이하 ‘베일람’)와 이를 이용하는 베일람

										서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, <br> 아울러 여러분의 베일람 서비스
						...
						<li id="terms_ul_li2"><span class="ul_li_span"> <input
							...
							<div class="terms_box">
								...
								<div class="article">
									...
									<p>
										...
										정보통신망법 규정에 따라 베일람에 회원가입 신청하시는 분께 수집하는 개인<br> 정보의 항목,
									...
									<p>
										...
										이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 베일람 <br>서비스를 회원과

										동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, <br>블로그 등과 같이 개인화 혹은

										회원제 서비스를 이용하기 위해 회원가입을 할<br> 경우, 베일람은 서비스 이용을 위해 필요한 최소한의
						...
						<li id="terms_ul_li3"><span class="ul_li_span"> <input
							...
							<div class="terms_box">
								...
								<div class="article">
									...
									<p>
										...
										위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong> 등을 포함하<br>는

										위치기반 서비스를 이용할 수 있습니다.
									...
									<p>
										...
										이 약관은 베일람 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치<br> 기반서비스사업과

										관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임<br> 사항, 기타 필요한 사항을 규정함을
						...
						<li id="terms_ul_li4"><span class="ul_li_span"> <input
				...
				<div id="err_check">
					...
					<span id="err_check_msg">이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.</span>
	...
	<footer>
		<div id="footer" class="divsize">
			...
			<div id="address">
				<span> <a href="http://localhost:8081/shop_csone/include/header.html"> <img
						id="addr_logo" src="img/logo2.png">
				</a>
				</span> <span>Copyright</span> <span>ⓒ <strong><a href="#">scone
							Corp.</a></strong></span> <span>All Rights Reserved.</span>
			</div>
		</div>
	</footer>
