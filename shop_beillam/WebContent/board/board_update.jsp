...
<body id="detailboard">
	...
	<div id="detail_board_all">
		...
		<form action="boardUpdatePlay.bizpoll" name="frm_bin" id="frm_bin" method="post" enctype="multipart/form-data">
		<div id="detail_body">
			<!-- colspan = 가로열 병합 -->
			<!-- rowspan = 세로열 병합 -->
			<div id="table_div">
				<table>
						...
						<td colspan="2">
							<div class="other_div">
								<label for="title" class="inputlabel" >제목</label> <input
									type="text" placeholder="제목을 입력해주세요." name="title" class="other_input" value="${boardView.title}">
					...
					<tr>
						<td colspan="2">
							<div class="cont-sub">
								<div id="content2">
									<textarea id="content" name="content" rows="" cols="">${boardView.content}</textarea>
					...
					<tr>
						...
						<td><div id="insert">
								<button id="insert_botton">수정</button>
							</div></td>
					</tr>
